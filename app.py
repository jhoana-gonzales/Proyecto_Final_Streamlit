...
En la lista de datasets preconfigurados se escribió "Al_Impact..." cuando el nombre correcto del archivo es "AI_Impact..."

Python intentaba buscar un archivo que no existía en la carpeta data/, provocando el error de archivo no encontrado

La solución fue simplemente cambiar la letra "l" por "I" mayúscula en el nombre del archivo dentro de la lista de opciones del selectbox.

el error persiste de la siguiente manera, corrige el código anterior
El error ahora es diferente: problema de codificación UTF-8. El archivo CSV no está en formato UTF-8, probablemente está en latin1 (ISO-8859-1) u otra codificación.

Aquí está el código totalmente corregido con manejo automático de codificaciones:
